...
% Text Node
\draw (179,110.4) node [anchor=north west][inner sep=0.75pt]    {$\mathrm{Spec}( A)$};
% Text Node
\draw (321,110.4) node [anchor=north west][inner sep=0.75pt]    {$\mathrm{Spec}( B)$};
% Text Node
\draw (179,190.4) node [anchor=north west][inner sep=0.75pt]    {$\mathrm{Spec}( A_{\mathfrak{p}})$};
% Text Node
\draw (321,190.4) node [anchor=north west][inner sep=0.75pt]    {$\mathrm{Spec}( B_{\mathfrak{p}})$};
% Text Node
\draw (154,274.4) node [anchor=north west][inner sep=0.75pt]    {$\mathrm{Spec}( A_{\mathfrak{p}} /\mathfrak{p} A_{\mathfrak{p}})$};
% Text Node
\draw (303.03,274.25) node [anchor=north west][inner sep=0.75pt]  [rotate=-0.17]  {$\mathrm{Spec}( B_{\mathfrak{p}} /\mathfrak{p} B_{\mathfrak{p}})$};
% Text Node
